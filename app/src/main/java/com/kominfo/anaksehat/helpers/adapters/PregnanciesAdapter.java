...
public class PregnanciesAdapter extends RecyclerView.Adapter<PregnanciesAdapter.MyViewHolder>
        implements Filterable {
    private Context context;
    private List<Pregnancy> dataList;
    private List<Pregnancy> dataListFiltered;
    private AdapterListener<Pregnancy> listener;
    ...
    public PregnanciesAdapter(Context context, List<Pregnancy> dataList, AdapterListener<Pregnancy> listener) {
    ...
    public void setData(List<Pregnancy> dataList){
        this.dataList = dataList;
        this.dataListFiltered = dataList;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final Pregnancy data = dataListFiltered.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<Pregnancy> filteredList = new ArrayList<>();
                    for (Pregnancy row : dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                dataListFiltered = (ArrayList<Pregnancy>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
