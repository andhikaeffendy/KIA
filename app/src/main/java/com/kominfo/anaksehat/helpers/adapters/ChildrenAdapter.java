...
public class ChildrenAdapter extends RecyclerView.Adapter<ChildrenAdapter.MyViewHolder>
    ...
    private List<Child> dataListFiltered;
    ...
    public ChildrenAdapter(Context context, List<Child> dataList, AdapterListener<Child> listener) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                dataListFiltered = (ArrayList<Child>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
