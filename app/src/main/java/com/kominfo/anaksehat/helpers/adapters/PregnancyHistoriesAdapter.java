...
public class PregnancyHistoriesAdapter extends RecyclerView.Adapter<PregnancyHistoriesAdapter.MyViewHolder>
        implements Filterable {
    private Context context;
    private List<PregnancyHistory> dataList;
    private List<PregnancyHistory> dataListFiltered;
    private AdapterListener<PregnancyHistory> listener;
    ...
    public PregnancyHistoriesAdapter(Context context, List<PregnancyHistory> dataList, AdapterListener<PregnancyHistory> listener) {
    ...
    public void setData(List<PregnancyHistory> dataList){
        this.dataList = dataList;
        this.dataListFiltered = dataList;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        final PregnancyHistory data = dataListFiltered.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<PregnancyHistory> filteredList = new ArrayList<>();
                    for (PregnancyHistory row : dataList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                dataListFiltered = (ArrayList<PregnancyHistory>) filterResults.values;
                notifyDataSetChanged();
            }
        };
    }
